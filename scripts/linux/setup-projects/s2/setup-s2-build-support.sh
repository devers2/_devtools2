...
TARGET_DIR="$HOME/workspaces/s2/s2-build-support"
REPO_URL="https://github.com/devers2/s2-build-support.git"

echo "🚀 [s2-build-support] 프로젝트 설정을 시작합니다."
